  ...
  l9.setBounds(470,180,200,25);
   ...
   l11.setBounds(470,260,180,25);
       ...
       l12.setBounds(470,300,180,25);
		...
		b1.setBounds(300,330,110,35);b1.setToolTipText("click to delete medicine details");
    ...
    if(ae.getSource()==b0)
	  {
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/medical_store","root","password");
