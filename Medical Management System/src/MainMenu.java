...
{   JFrame jf;
	...
	public MainMenu()
	{
		...
		ml = new JLabel("Medical Store Management System");
		ml.setForeground(new Color(139, 0, 139));
		ml.setFont(new Font("Algerian", Font.BOLD, 20));
		ml.setBounds(250, 11, 415, 33);
		getContentPane().add(ml);
		
		il = new JLabel("");
		il.setIcon(new ImageIcon("D:\\New folder\\GH\\MMS\\medical.png"));
		il.setBounds(20, 0, 900, 600);
